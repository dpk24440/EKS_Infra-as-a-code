...
cd myagent
./config.sh --unattended --url https://dev.azure.com/kovvuri2440 --auth pat --token 92v6xMcEtJF7batGVZ6v1AELtU7AcwdBuStTMBcksQGPKMFkHRKaJQQJ99BAACAAAAAAAAAAAAASAZDOsdtS --pool Default --agent newkeyaccess --acceptTeeEula
